    ...
    <div className="px-3 flex flex-col gap-3">
      ...
      <ScrollArea.Root type="scroll" className="overflow-hidden">
        ...
        <ScrollArea.Scrollbar
          className={`flex touch-none select-none bg-zinc-800 p-0.5 transition-colors
            duration-[160ms] ease-out data-[orientation=horizontal]:h-2.5
            data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col`}
          orientation="vertical"
        >
          <ScrollArea.Thumb
            className={`relative flex-1 rounded-[10px] bg-zinc-600 before:absolute
