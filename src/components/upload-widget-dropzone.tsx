...
export function UploadWidgetDropzone() {
  ...
  const { isThereAnyPendingUploads, globalPercentange } = usePendingUploads()
  ...
  return (
    ...
    >
      <div
        ...
        className={`cursor-pointer text-zinc-400 bg-black/[0.2] p-5 rounded-lg
          border border-zinc-700 border-dashed h-32
          flex flex-col items-center justify-center gap-1
          hover:border-zinc-600 transition-colors
          data-[active=true]:bg-indigo-500/[0.1]
